...
export const Offer = (): JSX.Element => {
    return (
        <div className="self-stretch flex w-full flex-col pt-24 pb-20 px-20 max-sm:pt-12 max-sm:pb-0 max-md:max-w-full max-md:px-5  backdrop-blur-[80px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(80px)_brightness(100%)] [background:linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0)_100%)] offer-card">
                                ...
                                <div className="border self-stretch mt-12 max-sm:mt-6 pl-6 pr-20 pt-1 pb-6 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:px-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(141.31,255,255,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
                                        ...
                                        <div className="flex flex-col items-stretch w-[61%] max-sm:w-[64%] ml-5 max-md:w-full max-md:ml-0">
                                            <div className="text-white text-2xl [font-family:'General_Sans-Regular'] max-sm:text-base max-sm:font-light max-sm:w-full max-sm:mt-5 max-sm:ml-5 font-medium w-[278px] max-w-[211px] my-auto max-md:mt-10">
