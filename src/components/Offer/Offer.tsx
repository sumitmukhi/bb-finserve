...
export const Offer = (): JSX.Element => {
    return (
        <section id="offer" className="self-stretch flex w-full flex-col pt-24 pb-20 px-20 max-sm:pt-[34px] max-sm:pb-0 max-md:max-w-full max-md:px-5  backdrop-blur-[80px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(80px)_brightness(100%)] [background:linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0)_100%)] offer-card">
            ...
            <div className="fixed hidden z-[1] max-sm:block w-[307px] h-[787px] top-[10px] left-[-200px] bg-[#002a38] rounded-[624px] rotate-180 blur-[200px]" />
                                    ...
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
                                        <div className="flex flex-col items-stretch w-[32%] max-sm:w-[25%] max-md:w-full max-md:ml-0">
                                            ...
                                            {/* <img
                                                ...
                                                className="hidden max-sm:block aspect-[1.2] object-contain object-center overflow-hidden max-w-full w-24 max-md:mt-10 max-sm:mt-0 lg:h-[90px]"
                                            /> */}
                                        </div>
            ...
            <div className="fixed hidden max-sm:block w-[282px] h-[787px] top-[10px] right-[-200px] bg-[#002a38] rounded-[624px] rotate-180 blur-[200px]" />
        </section>
    );
};