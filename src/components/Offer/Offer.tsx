                ...
                <div className="self-stretch mt-16 max-md:max-w-full max-md:mt-10">
                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                        <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
                            <div className="border flex grow flex-col w-full mx-auto pt-20 max-sm:pt-10 pb-6 px-5 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:mt-8 border-[#ffffff33] [background:linear-gradient(90deg,rgba(56,105,105,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                <img
                                    loading="lazy"
                        ...
                        <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
                            <div className="flex grow flex-col max-md:max-w-full max-md:mt-8 max-sm:mt-6">
                                <div className="border self-stretch pl-7 pr-5 py-6 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:pl-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(56,105,105,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                ...
                                <div className="border self-stretch mt-12 max-sm:mt-6 pl-6 pr-20 pt-1 pb-6 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:px-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(56,105,105,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
                                ...
                                <div className="border self-stretch mt-12 max-sm:mt-6 pl-7 pr-5 pt-5 pb-8 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:pl-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(56,105,105,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
