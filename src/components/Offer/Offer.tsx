...
export const Offer = (): JSX.Element => {
    return (
        <section id="offer" className="z-[3] [background:#0B0B0B]">
            <div className="relative self-stretch flex w-full flex-col pt-24 max-sm:pt-0 pb-20 px-20 max-sm:pb-0 max-md:max-w-full max-md:px-5  backdrop-blur-[80px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(80px)_brightness(100%)] [background:linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0)_100%)] offer-card">
