...
export const Offer = (): JSX.Element => {
    return (
        <section id="offer" className="self-stretch flex w-full flex-col pt-24 pb-20 px-20 max-sm:pt-15 max-sm:pb-0 max-md:max-w-full max-md:px-5  backdrop-blur-[80px] backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(80px)_brightness(100%)] [background:linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0)_100%)] offer-card">
                ...
                <div className="self-stretch mt-16 max-md:max-w-full max-md:mt-10">
                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                        <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
                            <div className="border flex grow flex-col w-full mx-auto pt-20 max-sm:pt-10 pb-6 px-5 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:mt-8 border-[#ffffff33] [background:linear-gradient(90deg,rgba(73,134,134,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                <img
                                    loading="lazy"
                                ...
                                />
                                <div className="text-white text-2xl [font-family:'General_Sans-Regular'] max-sm:text-base max-sm:font-normal font-medium self-stretch mt-9 max-md:max-w-full">
                        ...
                        <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
                            <div className="flex grow flex-col max-md:max-w-full max-md:mt-8 max-sm:mt-6">
                                <div className="border self-stretch pl-7 pr-5 py-6 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:pl-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(73,134,134,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
                                        <div className="flex flex-col items-stretch w-[32%] max-sm:w-[32%] max-md:w-full max-md:ml-0">
                                            <img
                                                loading="lazy"
                                                ...
                                                className="aspect-[1.41] object-contain object-center w-32 overflow-hidden max-w-full max-md:mt-10 max-sm:mt-0"
                                            />
                                        </div>
                                        <div className="flex flex-col items-stretch w-[68%] max-sm:w-[64%] ml-5 max-md:w-full max-md:ml-0">
                                            <div className="text-white text-2xl [font-family:'General_Sans-Regular'] max-sm:text-base max-sm:font-light max-sm:w-full max-sm:mt-3 max-sm:ml-5 font-medium w-[278px] max-w-[278px] my-auto max-md:mt-10 lg:mt-[-10px]">
                                                Refinancing Services for Existing Commercial Vehicles
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="border self-stretch mt-12 max-sm:mt-6 pl-6 pr-20 pt-1 pb-6 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:px-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(73,134,134,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
                                        <div className="flex flex-col items-stretch w-[39%] max-sm:w-[32%] max-md:w-full max-md:ml-0">
                                            <img
                                                loading="lazy"
                                        ...
                                        <div className="flex flex-col items-stretch w-[61%] max-sm:w-[64%] ml-5 max-md:w-full max-md:ml-0">
                                            <div className="text-white text-2xl [font-family:'General_Sans-Regular'] max-sm:text-base max-sm:font-light max-sm:w-full max-sm:mt-5 max-sm:ml-5 font-medium w-[278px] max-w-[211px] my-auto max-md:mt-10 lg:mt-[25px]">
                                                Loans with Balance Transfer options
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="border self-stretch mt-12 max-sm:mt-6 pl-7 pr-5 pt-5 pb-8 rounded-3xl border-solid border-white border-opacity-20 max-md:max-w-full max-md:pl-5 border-solid border-[#ffffff33] [background:linear-gradient(90deg,rgba(73,134,134,0.36)_0%,rgba(141.31,255,255,0)_97.47%)]">
                                    <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0 max-sm:flex-row">
                                        <div className="flex flex-col items-stretch w-[31%] max-sm:w-[32%] max-md:w-full max-md:ml-0">
                                            <img
                                                loading="lazy"
                                                ...
                                                className="aspect-[1.44] object-contain object-center w-[124px] overflow-hidden max-w-full max-md:mt-10 max-sm:mt-0"
                                            />
                                        </div>
                                        <div className="flex flex-col items-stretch w-[69%] max-sm:w-[64%] ml-5 max-md:w-full max-md:ml-0">
                                            <div className="text-white text-2xl [font-family:'General_Sans-Regular'] max-sm:text-base max-sm:font-light max-sm:w-full max-sm:mt-3 max-sm:ml-5 font-medium w-[278px] max-w-[278px] my-auto max-md:mt-10">
