...
export const Landing = (): JSX.Element => {
    return (
        <section id="home" className="max-sm:relative lg:h-[100vh]">
            ...
            <div className="self-stretch z-[1] flex w-full w-[60%] m-auto pt-0 max-sm:pt-12 flex-col pb-16 px-20 max-md:max-w-full max-md:px-5 [background:linear-gradient(0deg,rgb(11,15,16)_40%,rgba(11,15,16,0)_100%)] ">
